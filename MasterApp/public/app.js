        ...
        app.client.request(
            ...
            function(statusCode, responsePayload) {
                if (statusCode == 200) {
                    ...
                    var hiddenIdInputs = document.querySelectorAll(
                        'input.hiddenIdInput'
                    );
                    ...
                    document.querySelector(
                        '#checksEdit1 .displayIdInput'
                    ).value =
                        responsePayload.id;
                    document.querySelector(
                        '#checksEdit1 .displayStateInput'
                    ).value =
                        responsePayload.state;
                    document.querySelector(
                        '#checksEdit1 .protocolInput'
                    ).value =
                        responsePayload.protocol;
